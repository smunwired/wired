...
"user_amended,frequency,cred_id,branch_id,cost_code,to_char(date_audited,\'yyyy-mm-dd hh24:mi:ss\') date_audited from transdet_audit order by tran_id")
...
for row in qSQLresults:
    ...
    mcursor.execute('''INSERT into transdet_audit (tran_id, tran_date, tran_creditor, tran_desc, tran_amount, cr_dr, tran_type_id, account_id, statement_date, cheque_no, receipt_ind, dd_ind, date_created, user_created, date_amended, user_amended, frequency, cred_id, branch_id, cost_code, date_audited )
                  values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)''',
                  (tid, trd, trc, dsc, amt, crdr, ttyd, accd, std, chq, rcpt, dd, dtc, usc, dta, usa, frqd, crdd, brnd, ccdd, dtad))
